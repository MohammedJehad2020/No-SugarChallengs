                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        ...
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            <li class="dropdown-menu-header">
                                ...
                                <span class="notification-tag badge badge-default badge-danger float-right m-0" id="notificationNumber">
                                    New</span>
                            </li>
                            <li class="scrollable-container media-list w-100">
                                ...
                                channel.bind('Illuminate\\Notifications\\Events\\BroadcastNotificationCreated',
                                    function(data) {
                                        ...
                                        document.getElementById("notificationNumber").innerHTML = count;
                                        // data.markAsRead();
                                    });
                                </script>
                                <!-- notification message from customer -->
                                ...
                                <a href="javascript:void(0)">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h6 id="title" class="media-heading"></h6>
                                            <p class="notification-text font-small-3 text-muted" id="body">
                                            </p>
                                            <small>
                                                <time class="media-meta text-muted" datetime="">
                                                </time>
                                            </small>
                                        </div>
                                    </div>
