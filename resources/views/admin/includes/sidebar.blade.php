        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="{{ route('admin.programs.create') }}" data-i18n="nav.dash.crypto">أضافة
                             برنامج جديد </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="{{ route('admin.patients.create') }}" data-i18n="nav.dash.crypto">أضافة
                             مستخدم جديد </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="{{ route('admin.determineUserRole') }}" data-i18n="nav.dash.crypto">تحديد
                             صلاحية للمستخدم </a>
                    </li>
                </ul>
            </li>
