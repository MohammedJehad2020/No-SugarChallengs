...
<div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="{{ asset('assets\front\images\slider\slider.png') }}" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="{{ asset('assets\front\images\slider\slider.png') }}" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="{{ asset('assets\front\images\slider\slider.png') }}" alt="Third slide">
    </div>
  </div>
</div>
<!--  -->
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
    ...
    <!-- <div class="ps-banner">
        <div> -->
            <!-- <img style="width:50%; display:block; margin-left:auto; margin-right:auto"
                src="{{ asset('assets\front\images\slider\nsugar.webp') }}" alt="">
        </div>
    </div> --> 
                                ...
                                <div class="ps-shoe mb-30">
                                    <div class="ps-shoe__thumbnail">
                                        ...
                                        <a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img
                                            style="width:400px; height: 300px;" src="{{ $program->image_url }}"
    ...
    <div class="ps-home-testimonial bg--parallax pb-80"
        data-background="{{ asset('assets/front/images/slider/slideshow2.jpg') }}">
        <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                        <div class="ps-post">
                            <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="blog-detail.html"></a><img
                                    style="height: 300px;" src="{{ asset('assets/front/images/slider/sugar.jpg') }}"
                                    alt=""></div>
                            <div class="ps-post__content"><a class="ps-post__title" href="blog-detail.html">أضرار
                                    السكريات</a>
                                <p>يؤدي تناول كميّاتٍ كبيرةٍ من السكريات إلى تخزين الطاقة الفائضة عن احتياجات الجسم على
                                    شكل دهون، كما أنَّ العديد من الأطعمة مثل الشوكولاتة، والبسكويت، والكيك، تحتوي على
                                    السكريات والدهون، التي تساهم في زيادة الوزن أو السمنة عند تناولها بكميّاتٍ كبيرة..
                                </p>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                        <div class="ps-post">
                            ...
                            <div class="ps-post__content"><a class="ps-post__title" href="blog-detail.html">فوائد التوقف
                                    عن تناول السكر المضاف والصناعي</a>
                                <p> يجب معرفة الأضرار الكبيرة على الصحة الناتجة عن التناول المفرط للسكريات والاستعداد
                                    بعدها للتوقف عن تناول السكر المضاف بشكل نهائي، فما هي هذه الأضرار الناتجة عن تناول
                                    السكر المضاف؟ وكيف يتم التوقف عن تناول السكر المضاف؟ وما هي فوائد الابتعاد عن تناول
                                    السكر المضاف؟
                                </p>
                                <a class="ps-morelink" href="blog-detail.html"> المزيد...<i
                                        class="fa fa-long-arrow-right"></i></a>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                        <div class="ps-post">
                            <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="blog-detail.html"></a><img
                                    style="height: 300px;" src="{{ asset('assets/front/images/slider/footer3.jpg') }}"
                                    alt=""></div>
                            <div class="ps-post__content"><a class="ps-post__title" href="blog-detail.html">مخاطر السكر
                                    المضاف</a>
                                <p>وقد يؤدي الإفراط في تناول السكريات المضافة إلى زيادة مستويات الدهون الثلاثية، وهو ما
                                    قد يزيد خطر إصابتك بمرض القلب. تسوس الأسنان. يؤدي تناول السكريات إلى تفاقم تسوس
                                    الأسنان عن طريق السماح للبكتيريا بالتكاثر والنمو.
                                </p>
                                <a class="ps-morelink" href="blog-detail.html">المزيد...<i
                                        class="fa fa-long-arrow-right"></i></a>
                            </div>
